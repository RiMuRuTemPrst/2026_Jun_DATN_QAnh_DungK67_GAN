...
The thesis effectively bridges the gap between deep learning complexity and practical efficiency, showcasing a robust and adaptable solution for next-generation image processing. Rather than competing on raw wall-clock speed against high-end GPUs or peak-optimized CPU libraries, the accelerator is positioned for deterministic, low-latency inference within a low, embedded power envelope (an estimated $\approx$10~W of programmable-logic power, against tens of watts for a desktop-class GPU), where operating inside a constrained power budget rather than absolute latency is the decisive advantage.
